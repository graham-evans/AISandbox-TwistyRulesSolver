...
public class WhiteCrossOrange implements SolverAlgorithmStep {
  ...
  public Optional<String> getMoves(String state) {
    ...
    return switch (p) {
      ...
      case EDGE_LEFT_LEFT -> Optional.of("L");
      case EDGE_LEFT_RIGHT -> Optional.of("L'");
      case EDGE_LEFT_BOTTOM -> Optional.of("L2");
      // right
      case EDGE_RIGHT_TOP -> Optional.of("U");
      case EDGE_RIGHT_LEFT -> Optional.of("D F D'");
      case EDGE_RIGHT_RIGHT -> Optional.of("R2");
      // back
      case EDGE_BACK_TOP -> Optional.of("U2");
      case EDGE_BACK_LEFT -> Optional.of("R' U R");
